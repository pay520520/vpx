...
$banEmailLabel = $lang['ban_email_label'] ?? '用户邮箱';
  ...
  <div class="card" id="ban-management">
    <div class="card-body">
      ...
      <form method="post" class="mb-3">
        ...
        <div class="row g-2">
          <div class="col-md-5">
            <input type="email" name="user_email" class="form-control" placeholder="<?php echo htmlspecialchars($banEmailLabel); ?>" required>
          </div>
          <div class="col-md-4">
